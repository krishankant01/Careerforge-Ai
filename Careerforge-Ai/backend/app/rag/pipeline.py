...
class RAGPipeline:
    ...
    async def ask_stream(
        ...
        full_answer = ""
        async for token in self._stream_llm(question, context, history_text, system_directive):
            full_answer += token
    ...
    async def _stream_llm(
        self, question: str, context: str, history: str, system_directive: str | None = None
    ) -> AsyncIterator[str]:
        """
